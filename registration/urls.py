...
urlpatterns = [
    ...
    path('dashboard/admin/attendance/', views.attendance_list_view, name='admin_attendance_list'),
    path('attendance/toggle/', views.admin_toggle_student_attendance_view, name='admin_toggle_attendance'),
    path('attendance/export/excel/', views.export_attendance_excel_view, name='export_attendance_excel'),
